...
- [1.2 宏观架构图：AI团队、集体大脑与协同协议](#12-宏观架构图ai团队集体大脑与协同协议)
...
- [2.1 核心指挥层：AI项目主管 (ai_xiangmu_zhuguan)](#21-核心指挥层ai项目主管-ai_xiangmu_zhuguan)
- [2.2 开发与实现层：前端与后端工程师](#22-开发与实现层前端与后端工程师)
- [2.3 质量与安全保障层：审查员、QA、安全分析师](#23-质量与安全保障层审查员qa安全分析师)
- [2.4 知识与部署层：技术文档、运维工程师](#24-知识与部署层技术文档运维工程师)
- [2.5 元系统与基础设施层：校验员](#25-元系统与基础设施层校验员)
- [2.6 最终角色职能矩阵 (V6.0)](#26-最终角色职能矩阵-v60)

### [第三章：知识层详解——集体大脑的构建与治理 (The Brain)](#第三章知识层详解集体大脑的构建与治理-the-brain)
- [3.1 设计的螺旋式进化：从“文件柜”到“知识图谱”的锻造之路](#31-设计的螺旋式进化从文件柜到知识图谱的锻造之路)
- [3.2 知识图谱的最终结构 (V4.2)](#32-知识图谱的最终结构-v42)
...
- [4.1 协同的核心：claude:research工具的终极设计](#41-协同的核心clauderesearch工具的终极设计)
  ...
  - [4.1.2 “三阶段查询”的内部工作流 (看地图 -> 协同检索 -> 提取)](#412-三阶段查询的内部工作流-看地图---协同检索---提取)
  - [4.1.3 与“AI知识图谱协调员” (ai_zhishi_tupu_xietiaoyuan) 的协同模式](#413-与ai知识图谱协调员-ai_zhishi_tupu_xietiaoyuan-的协同模式)
- [4.2 一个专家AI的标准工作流程 (SOP)](#42-一个专家ai的标准工作流程-sop)
  - [4.2.1 阶段一：任务解析与自主研究](#421-阶段一任务解析与自主研究)
  - [4.2.2 阶段二：开发计划制定 (TODO List)](#422-阶段二开发计划制定-todo-list)
  - [4.2.3 阶段三：编码与实现](#423-阶段三编码与实现)
  - [4.2.4 阶段四：验证与结构化汇报](#424-阶段四验证与结构化汇报)
- [4.3 一个新功能诞生的端到端生命周期](#43-一个新功能诞生的端到端生命周期)
  - [4.3.1 启动与解析](#431-启动与解析)
  - [4.3.2 优化后的并行工作流：架构桩与QA前置](#432-优化后的并行工作流架构桩与qa前置)
  - [4.3.3 强制的质量门控：持续审查与测试循环](#433-强制的质量门控持续审查与测试循环)
  - [4.3.4 收尾、部署与学习闭环](#434-收尾部署与学习闭环)
- [4.4 系统的“免疫系统”：风险控制与异常处理](#44-系统的免疫系统风险控制与异常处理)
  - [4.4.1 “复杂任务模板”：驾驭高风险操作的“紧急检查清单”](#441-复杂任务模板驾驭高风险操作的紧急检查清单)
  - [4.4.2 “实时反思循环”：从“死循环”到“成长螺旋”的即时学习机制](#442-实时反思循环从死循环到成长螺旋的即时学习机制)
  - [4.4.3 终极安全阀：请求人类干预的异常处理协议](#443-终极安全阀请求人类干预的异常处理协议)

### [第五章：团队的灵魂——“道、法、术”统一框架与系统指令创作](#第五章团队的灵魂道法术统一框架与系统指令创作)
- [5.1 “道法术”框架全解](#51-道法术框架全解)
